...
'''
Predict variant scores using Enformer (https://github.com/google-deepmind/deepmind-research/tree/master/enformer)
...
Usage:
python3 predict_scores_e.py -v ${variants.vcf} -f ${genome.fa} -t ${targets.txt} -o ${outdir}
'''
...
def main():
    ...
    # All Scores
    it = variant_centered_sequences(var_vcf, sequence_length=SEQUENCE_LENGTH,
